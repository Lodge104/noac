                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-8">
                                          <div class="tab-content" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="Personal-<?php echo $getAdult['bsa_id']; ?>" role="tabpanel" aria-labelledby="list-home-list"><?php echo $getAdult['address_line1'] . ", " . $getAdult['address_line2']; ?><br><?php echo $getAdult['city'] . ", " . $getAdult['state'] . " " . $getAdult['zip']; ?><br><b>Date of Birth: </b><?php echo $getAdult['dob']; ?><br><b>Gender: </b><?php echo $getAdult['gender']; ?><br><b>T-Shirt Size: </b><?php echo $getAdult['tshirt']; ?><br><b>Emergency Contact Name: </b><?php echo $getAdult['ec_fn'] . " ". $getAdult['ec_lnn']; ?><br><b>Emergency Contact Relationship: </b><?php echo $getAdult['ec_relationship']; ?><br><b>Emergency Contact Email: </b><?php echo $getAdult['ec_email']; ?><br><b>Emergency Contact Phone: </b><?php echo $getAdult['ec_phone']; ?></div>
                                            ...
                                            <div class="tab-pane fade" id="Payment-<?php echo $getAdult['bsa_id']; ?>" role="tabpanel" aria-labelledby="list-profile-list"><b>Payment Option: </b><?php if ($getAdult['payment'] == '1') { ?>Pay in Full<br><b>Paid in Full?: </b><?php if ((in_array("NOAC Paid-in-Full-Y", $sku)) || (in_array("NOAC Paid-in-Full", $sku))) { ?> Yes <?php } else { ?>No<?php }                                                                                                                                                                                                                                                                                                                                                                                               } else { ?>Payment Plan<br><?php } ?></div>
                                          </div>
                                        </div>
                                      </div>
